    ...
    >
      ...
      <Modal.Body>
        ...
        <InputGroup style={{ marginBottom: "1rem" }}>
          ...
          <FormControl id="Name" placeholder="First Name" value={firstname} onChange={(e)=>setFirstname(e.target.value)}/>
        </InputGroup>
        ...
        <InputGroup style={{ marginBottom: "1rem" }}>
          ...
          <FormControl id="Name" placeholder="Last Name" value={lastname} onChange={(e)=>setLastname(e.target.value)}/>
        </InputGroup>
        ...
        <InputGroup style={{ marginBottom: "1rem" }}>
          ...
          <FormControl id="Phone Number" placeholder="Phone Number" value={phone} onChange={(e)=>setPhone(e.target.value)}/>
        </InputGroup>
        ...
        <InputGroup style={{ marginBottom: "1rem" }}>
          ...
          <FormControl id="Location" placeholder="Location" value={location} onChange={(e)=>setLocation(e.target.value)}/>
        </InputGroup>
      ...
      <Modal.Footer>
        ...
        <Button onClick={(e)=>updateProfile(e)} className="btn--primary" variant="primary">
          UPDATE
        </Button>
      </Modal.Footer>
    </Modal>
